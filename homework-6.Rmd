...
To do this convestion we will use as() funtion. This conversion is to make the association rules after.To do this conversion we needed to delete the first column as it wasn't a factor and have all the other columns as factors.
```{r}
